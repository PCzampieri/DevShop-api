...
export class Initial1615647408768 implements MigrationInterface {
    name = 'Initial1615647408768'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "brand" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(250) NOT NULL, "slug" character varying(250) NOT NULL, "logo" character varying(450), CONSTRAINT "PK_a5d20765ddd942eb5de4eee2d7f" PRIMARY KEY ("id"))`
        )
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(250) NOT NULL, "description" character varying(900) NOT NULL, "slug" character varying(250) NOT NULL, "categoryId" uuid, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`
        )
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "auth_token" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL, "lastUsedAt" TIMESTAMP NOT NULL, "active" boolean NOT NULL, "userAgent" character varying NOT NULL, "userId" uuid, CONSTRAINT "PK_4572ff5d1264c4a523f01aa86a0" PRIMARY KEY ("id"))`
        )
        await queryRunner.query(
